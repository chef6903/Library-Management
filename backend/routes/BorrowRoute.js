...
router.post(
  "/accept-borrow-request/:borrowId",
...
router.post(
  "/decline-borrow-request/:id",
  jwtConfig.requireAuth,
  borrowController.declineBorrowRequest
);
...
router.get(
  "/borrow-history",
  jwtConfig.requireAuth,
  borrowController.getReturnHistory
);
...
router.get(
  ...
  jwtConfig.requireAuth,
  borrowController.getReturnHistoryByUser
);

// xác nhận người dùng đã lấy sách
router.post(
  "/confirm-pickup/:borrowId",
  jwtConfig.requireAuth,
  borrowController.confirmBookPickup
);
...
router.post(
  "/cancel/:borrowId",
  jwtConfig.requireAuth,
  borrowController.cancelBorrowRequest
);
