...
const ViewListBorrowed = () => {
  ...
  const fetchBorrowedBooks = async () => {
    try {
      ...
      setBorrowingList(res.borrowRequests || []);
    } catch (error) {
              ...
              {borrowingList.length === 0 ? (
                ...
                borrowingList.map((item) => (
                  ...
                  >
                    ...
                    <td style={tdStyle}>
                      {new Date(item.createdRequestAt).toLocaleDateString(
                        "vi-VN"
                      )}
                    </td>
                    <td style={tdStyle}>
                    ...
                    <td style={tdStyle}>
                      <button
                        style={{ ...returnBtnStyle, marginRight: "8px" }}
            ...
            <div style={modalContent}>
              ...
              {returnList.map((item, idx) => (
                <div key={item.barcode} style={{ marginBottom: "10px" }}>
                  <strong>{idx + 1}. Mã sách:</strong> {item.barcode}
                  <br />
                  <select
                    value={item.condition}
                    onChange={(e) =>
                      handleConditionChange(item.barcode, e.target.value)
                    }
              ...
              <div style={{ textAlign: "right" }}>
                ...
                <button onClick={handleSubmitReturn} style={confirmBtnStyle}>
                  Xác nhận trả
                </button>
              </div>
            </div>
          ...
          <div style={modalOverlay}>
            <div style={modalContent}>
              ...
              <div style={{ textAlign: "right" }}>
                ...
                <button onClick={handleSubmitExtend} style={confirmBtnStyle}>
                  Xác nhận gia hạn
                </button>
              </div>
            </div>
